...
{/* "What's next?" CTA */}
      ...
      >
        <div className="mx-auto max-w-xl text-center">
          ...
          <p className="mt-4 text-surface-400">
            Get notified about new generators, features, and platform updates.
          ...
          >
            ...
            >
              {waitlistStatus === "submitting" ? "Subscribing..." : "Get Updates"}
            </button>
          </form>
          ...
          <p className="mt-4 text-xs text-surface-600">
            No spam, ever. Product updates only — unsubscribe anytime.
          </p>
        </div>
      </section>
